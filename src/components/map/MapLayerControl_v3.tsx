...
const MapLayerControlV3: React.FC<MapLayerControlV3Props> = ({
  handleOnSelect,
  selectedLayer,
}) => {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className="text-primary-700 bg-white p-1 rounded-lg border-primary-700 border-2 absolute top-[60px] left-1 z-10"
      >
...
export default MapLayerControlV3;
